...
final flutterPrinterChannel = const MethodChannel('do.cactus.flutter_pos_printer_platform');
final flutterPrinterEventChannelUSB = const EventChannel('do.cactus.flutter_pos_printer_platform/usb_state');
